...
/// Simple wrapper around a `TQ3Object` that calls `Q3Object_Dispose`
/// when all references to `CQ3Object` are removed.
...
///     }
public struct GroupIterator: Sequence {
